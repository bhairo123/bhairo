...
<body>
    ...
    style="width:45px;height:45px">
		...
		<div class="wrap">
		<a href="dashboard.php" class="aktif"> <i class="fas fa-tachometer-alt-slow"></i> Dashboard</a>
...
<a href="logout.php">logout <i class="fas fa-sign-out"></i></a>
	...
	<div class="content">
		<div class="header">
			...
			<p class="sign"><span id="time"></span>ADMIN SKANAWA</p>
...
<div class="row">
	<div class="col-9">
		<div>
			...
			<?php 
	$row = mysqli_query($conn, "SELECT * FROM comment ORDER BY id DESC limit 1")
			?>
			<?php foreach ($row as $rows) : ?>
			<div class="k" style="width:470px;" >
				<h2>NEW COMENT</h2>
...
<a href="guru.php"><button class="custom-btn btn-9 a" title="tambah dan hapus guru" >DATA GURU</button></a>
<a href="upload.php"><button class="custom-btn btn-9 a" title="upload berita" >UPLOAD</button></a>
<a href="comment.php"><button class="custom-btn btn-9 a" title="data komentar" >COMMENT</button></a>
...
<div class="row" style="margin-top: 30px">
	...
	<?php 
$row = mysqli_query($conn, "SELECT * FROM laporan ORDER BY id DESC limit 1")
	?>
			<?php foreach ($row as $rows) : ?>
			<p><?php echo $rows['laporan']; ?></p>
			<?php endforeach; ?>
		</div> 
	...
	<div class="col-6">
		...
		<?php 
$row = mysqli_query($conn, "SELECT * FROM contact ORDER BY id DESC limit 1")
		?>
				<?php foreach ($row as $rows) : ?>
				<h2>NEW CONTACT</h2>
