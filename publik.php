...
style="width:45px;height:45px">
    ...
    <div class="item"><a href="jurusan.php"><lord-icon
      ...
      <div class="item active"><a href="publik.php"><lord-icon
    ...
    <section class="header">
        <div class="title-wrapper">
          <h1 class="sweet-title">
            ...
            <span data-text="PUBLIC SERVICES">PUBLIC SERVICES</span>
          </h1>
      ...
      <div class="bdy-glmb">
        ...
        <div class="isi">
            <div class="box-buton">
                <button id="btn_1" onclick="openA()">PROFESSIONAL CERTIFICATION INSTITUTION<br><lord-icon src="https://cdn.lordicon.com/nocovwne.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                <button id="btn_2" onclick="openB()">JOB FAIR<br><lord-icon src="https://cdn.lordicon.com/fhtaantg.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                <button id="btn_3" onclick="openC()">PRODUCTION UNIT<br><lord-icon src="https://cdn.lordicon.com/qhviklyi.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
              </div>
