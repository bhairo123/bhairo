...
<body>
    ...
    style="width:45px;height:45px">
		...
		<a href="dashboard.php"><i class="fas fa-tachometer-alt-slow"></i> Dashboard</a>
			<a href="comment.php" class="aktif"><i class="fas fa-comments-alt"></i> Comment</a>
...
<a href="logout.php">logout <i class="fas fa-sign-out"></i></a>
	...
	<div class="content">
		<div class="header">
		<div>
			<p><span id="time"></span>ADMIN SKANAWA</p><br><br>
		<p>COMMENT<lord-icon
...
<?php 
			...
			?>
         <div class="komentar">
             <h2><?php echo $row['name']; ?><span>  <?php echo $row['namea']; ?></span></h2>
