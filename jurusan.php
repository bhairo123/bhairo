    ...
    <section class="header">
        <div class="title-wrapper">
          <h1 class="sweet-title">
            ...
            <span data-text="EXPERTISE PROGRAM">EXPERTISE PROGRAM</span>
          </h1>
      ...
      <div class="bdy-glmb">
        ...
        <div class="isi">
            <div class="box-buton">
                <button id="btn_1" onclick="openA()">MOTORCYCLE TECHNIQUE<br><lord-icon src="https://cdn.lordicon.com/sbiheqdr.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                <button id="btn_2" onclick="openB()">COMPUTER & NETWORK ENGINEERING<br><lord-icon src="https://cdn.lordicon.com/qhgmphtg.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                <button id="btn_3" onclick="openC()">SOFTWARE ENGINEERING<br><lord-icon src="https://cdn.lordicon.com/nobciafz.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
              </div>
              ...
              <div class="isi">
                <div class="box-buton-a">
                  <button id="btn_4" onclick="openD()">ANIMATION<br><lord-icon src="https://cdn.lordicon.com/wloilxuq.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                  <button id="btn_5" onclick="openE()">INDUSTRIAL ELECTRONICS<br><lord-icon src="https://cdn.lordicon.com/qghrdngw.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                </div>
