...
<body>
    <section class="header">
      ...
      <div class="bdy-glmb">
        ...
        <div class="isi">
            <div class="box-buton">
                <button id="btn_1" onclick="openA()">HISTORY<br><lord-icon src="https://cdn.lordicon.com/puvaffet.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                <button id="btn_2" onclick="openB()">VISION & MISSION<br><lord-icon src="https://cdn.lordicon.com/xqnbvely.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                <button id="btn_3" onclick="openC()">QUALITY TARGET<br><lord-icon src="https://cdn.lordicon.com/iltqorsz.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
              </div>
              ...
              <div class="isi">
                <div class="box-buton-a">
                  <button id="btn_4" onclick="openD()">PURPOSE<br><lord-icon src="https://cdn.lordicon.com/qjvxqdov.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                  <button id="btn_5" onclick="openE()">ORGANIZATIONAL STRUCTURE<br><lord-icon src="https://cdn.lordicon.com/uukerzzv.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                  <button id="btn_6" onclick="openF()">FACILITIES AND INFRASTRUCTURE<br><lord-icon src="https://cdn.lordicon.com/oudlegmg.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                  <button id="btn_7" onclick="openG()">SCHOOL MAP<br><lord-icon src="https://cdn.lordicon.com/zzcjjxew.json"trigger="hover"delay="1000"colors="primary:#482896,secondary:#482896"stroke="50"style="width:50px;height:50px"></lord-icon></button>
                </div>
                ...
                <div id="G" class="tampilan">
                  <div class="tampilan-right">
                 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.165587118891!2d112.687477!3d-7.9818289!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd628945c99f363%3A0xb0681c1ba2eabe58!2sSMK%20Negeri%209%20Kota%20Malang!5e0!3m2!1sid!2sid!4v1642502557463!5m2!1sid!2sid" width="95%" height="190%"></iframe>
                </div>
                  <div class="tampilan-left">
                  <h1>lorem ipsum</h1>
                  <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veniam, mollitia cumque? Voluptatibus, dolore similique at iure rem eius impedit fuga non ratione magnam nihil animi fugiat quae, consequatur illum magni.</p>
                  </div>
