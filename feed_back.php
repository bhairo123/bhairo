...
<body>
    ...
    style="width:45px;height:45px">
		...
		<a href="dashboard.php"><i class="fas fa-tachometer-alt-slow"></i> Dashboard</a>
			...
			<a href="feed_back.php" class="aktif"><i class="fas fa-comment-alt-exclamation"></i> Feed Back</a>
...
?>
<?php 
	$row = mysqli_query($conn, "SELECT * FROM laporan ORDER BY id DESC;");
			?>
			<?php foreach ($row as $rows) : ?>
         <div class="komentar">
             <h2><?php echo $rows["nama"]; ?><span>_<?php echo $rows["akhir"]; ?></span></h2>
             <h3><?php echo $rows["gmail"]; ?></h3>
			 <h3><?php echo $rows["no"]; ?></h3>
